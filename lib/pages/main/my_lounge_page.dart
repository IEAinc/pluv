                   ...
                   child: GestureDetector(
                     ...
                     child: Center(
                       child: Container(
                         ...
                         child: Center(child: Text("내가 작성한 글",style:_currentIndex==0?TextStyles.title24_b: TextStyles.title24_b,)),
                       ),
                     ),
                   ),
                 ),
                   ...
                   child: GestureDetector(
                     ...
                     child: Center(
                       child: Container(
                         ...
                         child: Center(child: Text("프로필 교환 내역",style:_currentIndex==1?TextStyles.title24_b: TextStyles.title24_b,)),
                       ),
                     ),
                   ),
                 ),
