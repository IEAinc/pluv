              ...
              child: Column(
                children: [
                  Stack(
                    ...
                    children: [
                      AvatarImage(size: 92,imagePath: authController.myInfo!.profileImageList?.first??"",),
                  ...
                  SizedBox(height: 20,),
                  Text("${authController!.myInfo!.nickName}",style: TextStyles.title18_b,),
                  Text("${authController!.myInfo!.memberJob}",style: TextStyles.contents15_b,),
                  SizedBox(height: 20,),
